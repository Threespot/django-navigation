...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('navigation_menu', 'template', self.gf('django.db.models.fields.CharField')(default='navigation/menu.html', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Menu.template'
        db.delete_column('navigation_menu', 'template')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MenuFolder.html_class_name'
        db.add_column('navigation_menufolder', 'html_class_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'MenuPage.html_class_name'
        db.add_column('navigation_menupage', 'html_class_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'MenuLink.html_class_name'
        db.add_column('navigation_menulink', 'html_class_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MenuFolder.html_class_name'
        db.delete_column('navigation_menufolder', 'html_class_name')

        # Deleting field 'MenuPage.html_class_name'
        db.delete_column('navigation_menupage', 'html_class_name')

        # Deleting field 'MenuLink.html_class_name'
        db.delete_column('navigation_menulink', 'html_class_name')
